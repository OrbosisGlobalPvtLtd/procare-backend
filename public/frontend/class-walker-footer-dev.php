...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        form.dropzone { min-height:200px;border:2px dashed #C99A2E;line-height:6rem; }
        ...
        i.fa.fa-file-code-o { color:#C99A2E }
        i.fa.fa-code { color:#cc4b4c }
        i.fa.fa-file-text-o { color:#0096e6 }
        i.fa.fa-html5 { color:#d75e72 }
        i.fa.fa-file-excel-o { color:#09c55d }
        i.fa.fa-file-powerpoint-o { color:#f6712e }
        i.go-back { font-size:1.2em;color:#C99A2E; }
        ...
        .lds-facebook div { position:absolute;left:6px;width:13px;background:#C99A2E;animation:lds-facebook 1.2s cubic-bezier(0,.5,.5,1) infinite }
