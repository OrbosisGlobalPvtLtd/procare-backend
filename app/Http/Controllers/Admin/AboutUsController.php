...
class AboutUsController extends Controller
{
    ...
    public function update_aboutus(Request $request){
        ...
        if($request->lang_code == 'en'){
            $rules['item1_title'] = 'required';
            $rules['item2_title'] = 'required';
        }
        ...
        /* -------Dynamicly Update------*/
        if($request->lang_code !== 'en'){
            updateOrCreateTransaltion($request, $about);
        }else{
    ...
    public function update_home2_aboutus(Request $request){
        ...
        if($request->lang_code == 'en'){
            $rules['home2_percentage'] = 'required';
        }
        ...
        if($request->lang_code !== 'en'){
            updateOrCreateTransaltion($request, $about, 'about_us');
        }else{
