...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.testimonial.edit', ['testimonial' => $testimonial->id, 'lang_code' => admin_lang()])->with($notification);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->lang_code !== 'en'){
            updateOrCreateTransaltion($request, $testimonial, 'testimonials');
        }else{
            $testimonial->name = $request->name;
            $testimonial->designation = $request->designation;
            $testimonial->comment = $request->comment;
    ...
    public function destroy($id)
    {
        $testimonial = Testimonial::find($id);
        $existing_image = $testimonial->image;
        $testimonial->deleteAllTranslations();
        $testimonial->delete();
