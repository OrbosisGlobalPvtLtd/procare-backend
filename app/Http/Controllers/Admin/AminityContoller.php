...
class AminityContoller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.aminity.edit',['aminity' => $aminity->id, 'lang_code' => admin_lang()])->with($notification);
    }
    ...
    { 
        ...
        if($request->lang_code !== 'en'){
            updateOrCreateTransaltion($request, $aminity);
        }else{
            $aminity->aminity = $request->aminity;
        }
