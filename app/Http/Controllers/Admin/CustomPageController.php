...
class CustomPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.custom-page.edit',['custom_page' => $customPage->id, 'lang_code' => admin_lang()])->with($notification);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->lang_code !== 'en'){
            updateOrCreateTransaltion($request, $customPage, 'custom_pages');
        }else{
            $customPage->page_name = $request->page_name;
            $customPage->slug = $request->slug;
            $customPage->description = $request->description;
    ...
    {
        $customPage = CustomPage::find($id);
        $customPage->deleteAllTranslations();
        $customPage->delete();
