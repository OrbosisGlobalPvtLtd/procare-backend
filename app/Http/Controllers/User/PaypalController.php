...
class PaypalController extends Controller
{
    ...
    public function payWithPaypal($slug){
        ...
        $currency_rate = $paypalSetting?->currency?->currency_rate ?? 1;
        $currency_code = $paypalSetting?->currency?->currency_code ?? 'USD';

        $payableAmount = round($pricing_plan->plan_price * $currency_rate,2);
