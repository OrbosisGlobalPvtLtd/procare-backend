...
class HomeController extends Controller
{
    ...
    public function website_setup(Request $request){
        $setting = Setting::select('id','logo','favicon','preloader_status','property_auto_approval','text_direction','app_name','currency_name','currency_icon','selected_theme','default_avatar', 'theme_one_color', 'theme_two_color')->first();
    ...
    public function city_by_country($country_id){
