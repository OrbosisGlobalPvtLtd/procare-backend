...
@endif
	<head>
		...
		<meta name="keywords" content="{{__('user.ProCare Legal Services || Forget Password')}}">
		<meta name="description" content="{{__('user.ProCare Legal Services || Forget Password')}}">
		<meta name="title" content="{{__('user.ProCare Legal Services || Forget Password')}}">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

		<!-- Site Title -->
		<title>{{__('user.ProCare Legal Services || Forget Password')}}</title>
