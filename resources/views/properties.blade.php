    ...
    <section class="homec-propertys pd-top-80 pd-btm-80">
        <div class="container">
            <form id="propertySearchForm">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="homec-property-bar" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; background: #F8F7F4; border: 1px solid #E5E7EB; border-radius: 8px; padding: 15px; margin-bottom: 30px;">
                            <div style="display: flex; gap: 15px; flex-wrap: wrap; flex-grow: 1;">
                                <div class="form-group" style="min-width: 200px; flex: 1; margin-bottom: 0;">
                                    <input value="{{ request()->get('search') }}" id="search_input" name="search" type="text"
                                        placeholder="{{ __('user.Search Property') }}..." style="border: 1px solid #E5E7EB; border-radius: 6px; padding: 10px 15px; width: 100%; height: 50px; background: #fff;">
                                </div>
                                <div class="form-group" style="min-width: 200px; flex: 1; margin-bottom: 0;">
                                    <select class="form-control select2 select_search" name="type" id="property_type" style="border: 1px solid #E5E7EB; border-radius: 6px; padding: 10px 15px; width: 100%; height: 50px; background: #fff;">
                                        <option value="" data-display="">{{ __('All Categories') }}</option>
                                ...
                                <div class="form-group" style="min-width: 200px; flex: 1; margin-bottom: 0;">
                                    <select class="form-control select2noSearch select_search" name="others_sorting" style="border: 1px solid #E5E7EB; border-radius: 6px; padding: 10px 15px; width: 100%; height: 50px; background: #fff;">
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    <button id="searchPropertyBtn" type="button" class="homec-btn" style="background-color: #C99A2E; color: #fff; border: none; padding: 10px 25px; border-radius: 6px; height: 50px; display: flex; align-items: center;">
                                        <span>{{ __('user.Search') }}</span>
                                    </button>
                                </div>
                            </div>
                            <div class="homec-property-bar__single last" style="margin-left: 20px; margin-top: 10px;">
...
$(document).ready(function () {
    ...
    let type = urlParams.get('property_type');

    if(type){
        // set value properly
        $('#property_type').val(type).trigger('change');
    }
