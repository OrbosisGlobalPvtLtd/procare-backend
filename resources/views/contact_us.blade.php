...
@section('frontend-content')
    ...
    <section class="homec-contact-form homec-bg-cover mg-top-100 position-relative" >
        <div class="position-absolute homec-contact-bg homec-bg-cover" style="background-image: url({{ asset($contact->supporter_image) }});">
        
        </div>
        <div class="pd-top-80 pd-btm-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
