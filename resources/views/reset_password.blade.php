...
@endif
	<head>
		...
		<meta name="keywords" content="{{__('user.ProCare Legal Services || Reset Password')}}">
		<meta name="title" content="{{__('user.ProCare Legal Services || Reset Password')}}">
		<meta name="description" content="{{__('user.ProCare Legal Services || Reset Password')}}">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

		<!-- Site Title -->
		<title>{{__('user.ProCare Legal Services || Reset Password')}}</title>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="ecom-wc__form">
                            <div class="ecom-wc__form-inner">
                                <h3 class="ecom-wc__form-title ecom-wc__form-title__one">{{__('user.Reset Password')}} <span>{{__('user.Please fill out the form and reset your password')}}</span></h3>
                                <!-- Sign in Form -->
                                <form class="ecom-wc__form-main p-0" action="{{ route('store-reset-password',$token) }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group homec-form-input">
                                                ...
                                                <div class="form-group__input">
                                                    <input class="ecom-wc__form-input" type="email" name="email" placeholder="{{__('user.Email')}}" value="{{ $user->email }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group homec-form-input">
                                                ...
                                                <div class="form-group__input">
                                                    <input class="ecom-wc__form-input" type="password" name="password_confirmation" placeholder="{{__('user.Confirm Password')}}">
                                                </div>
                                            </div>
                                        </div>
