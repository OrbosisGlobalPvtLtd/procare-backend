...
@endif
	<head>
		...
		<meta name="keywords" content="{{__('user.ProCare Legal Services || Login')}}">
		<meta name="description" content="{{__('user.ProCare Legal Services || Login')}}">
		<meta name="title" content="{{__('user.ProCare Legal Services || Login')}}">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

		<!-- Site Title -->
		<title>{{__('user.ProCare Legal Services || Login')}}</title>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="ecom-wc__form">
                            <div class="ecom-wc__form-inner">
                                <h3 class="ecom-wc__form-title ecom-wc__form-title__one">{{__('user.Login')}} <span>{{__('user.To access our platform please login first')}}</span></h3>
                                <!-- Sign in Form -->
