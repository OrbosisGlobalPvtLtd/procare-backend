                    ...
                    <div class="homec-image-group homec-image-group--v2">
                        <div class="homec-image-group__main">
                            ...
                            <div class="homec-experiences">
                                <h4 class="homec-experiences__title">{{ $about_us->experience_text_1 }}
                                    <span>{{ $about_us->experience_text_2 }}</span></h4>
                            </div>
                        </div>
                        <div class="homec-ceo-quote">
                            <div class="homec-ceo-quote__img">
                                <div class="homec-overlay"></div>
                                <img src="{{ $about_us->author_image ? asset($about_us->author_image) : asset($setting->default_placeholder) }}"
                                    alt="author_image">
                            </div>
                            <h4 class="homec-ceo-quote__title">
                                {{ $about_us->author_name }}<span>{{ $about_us->author_designation }}</span></h4>
                        </div>
                    </div>
                        ...
                        <div class="homec-section__head">
                            <div class="homec-section__shape">
                                <span class="homec-section__badge homec-section__badge--shape" data-aos="fade-down"
                                    data-aos-delay="300">{{ $about_us->short_title }}</span>
                            </div>
                            <h2 class="homec-section__title" data-aos="fade-in" data-aos-delay="400">
                                {{ $about_us->long_title }}</h2>
                        </div>
                            ...
                            <div class="homec-dflex-space">
                                <div class="homec-funfact__single homec-funfact__single--v2">
                                    ...
                                    <h3 class="homec-funfact__number"><span
                                            class="counter">{{ $about_us->item1->title }}</span>{{ $about_us->item1->title2 }}
                                    </h3>
            ...
            <div class="row">
                @foreach ($property_types as $property_type)
                    <div class="col-lg-3 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="400">
                        <!-- Single Feature -->
                        <a href="{{ route('properties', ['type' => $property_type->slug]) }}"
                            class="homec-features__single">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5 col-12">
                                <div class="homec-funfact__inner">
                                    ...
                                    <!-- Homec List -->
                                    <ul class="homec-iconic-list list-none mg-top-30" data-aos="fade-up"
                                        data-aos-delay="400">
                                    ...
                                    <div class="homec-btn__main mg-top-40" data-aos="fade-up" data-aos-delay="500">
                                        <a href="{{ route('contact-us') }}"
                                            class="homec-btn"><span>{{ __('user.Contact Us') }}</span></a>
                                    </div>
                                        ...
                                        @foreach ($counter->items as $counter_item)
                                            <div class="col-lg-6 col-md-6 col-12" data-aos="fade-in"
                                                ...
                                                <div class="homec-funfact__single homec-border">
                                                    ...
                                                    <h3 class="homec-funfact__number"><span
                                                            class="counter">{{ $counter_item->number }}</span></h3>
                ...
                <div class="col-12">
                    <div class="homec-flex homec-flex__section mg-btm-60">
                        ...
                        <div class="homec-section__btn mg-top-30" data-aos="fade-right" data-aos-delay="500">
                            <a href="{{ route('agents') }}"
                                class="homec-btn"><span>{{ __('user.See All Agents') }}</span></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="homec-agent">
                                        ...
                                        <div class="homec-agent__head">
                                            ...
                                            <ul class="homec-agent__social list-none">
                                                ...
                                                @if ($single_agent->twitter)
                                                    <li><a href="{{ $single_agent->twitter }}"><i
                                        ...
                                        <div class="homec-agent__body">
                                            <h4 class="homec-agent__title"><a
                                                    href="{{ route('agent', ['agent_type' => 'agent', 'user_name' => $single_agent->user_name]) }}">{{ $single_agent->name }}<span>{{ $single_agent->designation }}</span></a>
                                            </h4>
                                        </div>
                                        <!-- End Agent Body -->
                                    </div>
