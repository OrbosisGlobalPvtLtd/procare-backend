...
@section('title')
    <title>{{ __('user.Agency Details') }}</title>
@endsection

@section('meta')
    <meta name="title" content="{{ $agency->user_name }}">
    <meta name="description" content="{{ $agency->user_name }}">
@endsection
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb__menu list-none">
                            ...
                            <li class="active"><a href="{{ route('agencies') }}">{{__('user.Our Agency')}}</a></li>
                        </ul>
                        <h2 class="breadcrumb__title m-0">{{ html_decode($agency?->profile->company_name) }}</h2>
                    </div>
                </div>
            </div>
        </div>
		...
		<section class="pd-top-70 pd-btm-100">
			<div class="container">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-12">
                                    <div class="homec-agent-detail__img">
                                        <img src="{{ ($agency?->profile?->image)? asset($agency?->profile?->image) : asset($setting->default_placeholder)}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="homec-agent-detail__body">
                                        <h3 class="homec-agent-detail__title">{{ $agency?->profile?->company_name }}</h3>
                                    ...
                                    <ul class="homec-agent__social homec-agent__social--inline list-none">
                                        @if ($agency?->profile?->linkedin)
                                        <li><a href="{{ html_decode($agency?->profile?->linkedin) }}"><i class="fab fa-linkedin-in"></i></a></li>
                                    @endif

                                    @if ($agency?->profile?->twitter)
                                    <li><a href="{{ html_decode($agency?->profile?->twitter) }}"><i class="fab fa-twitter"></i></a></li>
                                    @endif

                                    @if ($agency?->profile?->instagram)
                                    <li><a href="{{ html_decode($agency?->profile?->instagram) }}"><i class="fab fa-instagram"></i></a></li>
                                    @endif

                                    @if ($agency?->profile?->facebook)
                                    <li><a href="{{ html_decode($agency?->profile?->facebook) }}"><i class="fab fa-facebook-f"></i></a></li>
                                    @endif
                                    </ul>
                                </div>
                            </div>
                            <div class="homec-agent-detail__inside mg-top-20">
                                <div class="homec-agent-detail__sticky--heading">
                                    <h2 class="homec-agent-detail__sticky--title">{{ __('user.About Us') }}</h2>
                                </div>
                                <p class="homec-agent-detail__sticky--text">{{ $agency?->profile?->about_us }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-5 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="homec-property-ag homec-bg-cover homec-agent-side-cover">
                            ...
                            <form id="agentEmailForm" class="homec-property-ag__form" method="POST">
                                ...
                                <input type="hidden" name="agent_email" value="{{ $agency->email }}">
                ...
                <div class="row mg-top-30">
                    <div class="col-lg-12">
                        <div class="agent_agency_btn">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                                        aria-selected="true">{{ __('user.Our Listing') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-profile" type="button" role="tab"
                                        aria-controls="pills-profile" aria-selected="false">{{ __('user.Our Agents') }}</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="col-12" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="homec-property-bar">
                                    <div class="homec-property-bar__single">
                                        <form class="homec-form__form homec-form__form--bar" action="{{ route('agency-details', ['id' => $agency->id]) }}">
                                                        ...
                                                        <div class="homec-property">
                                                            ...
                                                            <div class="homec-property__head">
                                                                ...
                                                                <div class="homec-property__hsticky">
                                                                    ...
                                                                    <a href="{{ route('agent', ['agent_type' => 'agent', 'user_name' => html_decode($property_item?->agent?->user_name)]) }}" class="homec-property__asticky homec-property__asticky_two ">
                                                                        <img src="{{ asset($property_item?->agent?->image) }}">
                                                                        <h4 class="homec-property__asticky--label">{{ $property_item?->agent?->name }}<span>{{ __('user.Agent') }}</span></h4>
                                                                    </a>
                                                            ...
                                                            <div class="homec-property__body">
                                                                <div class="homec-property__topbar">
                                                                    <div class="homec-property__price">{{ html_decode(num_format($property_item->price)) }}
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="homec-property-bar" style="justify-content: end !important">
                            <div class="homec-property-bar__single">
                                <form class="homec-form__form homec-form__form--bar" action="{{ route('agency-details', ['id' => $agency->id]) }}">
                                    <input type="text" name="agent_search" value="{{ Request()->get('search') }}" placeholder="Search Agency/Agent...">
                                    <button type="submit" class="homec-btn"><span>{{ __('user.Search Now') }}</span></button>
    ...
    <script>
        (function($) {
            ...
            $(document).ready(function () {
                ...
                @if(!empty(Request()->get('agent_search')))
