        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-12">
                <div class="homec-contact-form" style="background: #FFFFFF; padding: 40px; border-radius: 10px; box-shadow: 0px 5px 20px rgba(0,0,0,0.05); border: 1px solid #E5E7EB;">
                    <h3 class="mg-btm-30" style="color: #1F2937;">Submit Your Request</h3>
                    <form action="{{ route('vaculation.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="homec-form-group">
                                    ...
                                    <input type="text" name="property_address" class="homec-form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="homec-form-group">
                                    <label>Service Type *</label>
                                    <select name="service_type" class="homec-form-control" required style="width: 100%; height: 50px; border: 1px solid #e2e8f0; border-radius: 5px; padding: 0 15px;">
                                        <option value="Vaculation">Vaculation</option>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="homec-form-group">
                                    ...
                                    <input type="file" name="document" class="homec-form-control" style="padding-top: 10px;">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="homec-form-group">
