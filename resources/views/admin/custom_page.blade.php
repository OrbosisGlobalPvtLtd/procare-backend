                            ...
                            <tbody>
                                @foreach ($customPages as $index => $customPage)
                                    <tr>
                                        ...
                                        <td> 
                                        <a href="{{ route('admin.custom-page.edit',['custom_page' => $customPage->id, 'lang_code' => admin_lang()] ) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
