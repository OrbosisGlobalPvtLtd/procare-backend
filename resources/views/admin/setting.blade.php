                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="map-generate-tab" data-toggle="tab" href="#mapGenerateTab" role="tab" aria-controls="mapGenerateTab" aria-selected="true">{{__('admin.Map')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                                    ...
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Preloader')}}</label>
                                                                <select name="preloader_status" id="" class="form-control">
                                                                    <option {{ $setting->preloader_status  == 'enable' ? 'selected' : '' }} value="enable">{{__('admin.Enable')}}</option>
                                                                    <option {{ $setting->preloader_status  == 'disable' ? 'selected' : '' }} value="disable">{{__('admin.Disable')}}</option>
                                                                </select>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Agent can add property ?')}}</label>
                                                                <select name="agent_can_add_property" id="" class="form-control">
                                                                    <option {{ $setting->agent_can_add_property  == 'enable' ? 'selected' : '' }} value="enable">{{__('admin.Enable')}}</option>
                                                                    <option {{ $setting->agent_can_add_property  == 'disable' ? 'selected' : '' }} value="disable">{{__('admin.Disable')}}</option>
                                                                </select>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Agent property auto approval')}}</label>
                                                                <select name="property_auto_approval" id="" class="form-control">
                                                                    <option {{ $setting->property_auto_approval  == 'yes' ? 'selected' : '' }} value="yes">{{__('admin.Yes')}}</option>
                                                                    <option {{ $setting->property_auto_approval  == 'no' ? 'selected' : '' }} value="no">{{__('admin.No')}}</option>
                                                                </select>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="mapGenerateTab" role="tabpanel" aria-labelledby="map-generate-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-map') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Live Map')}}</label>
                                                                <select name="live_map" class="form-control">
                                                                    <option {{ $setting->live_map == 'yes' ? 'selected' : '' }} value="yes">{{__('admin.Enable')}}</option>
                                                                    <option {{ $setting->live_map == 'no' ? 'selected' : '' }} value="no">{{__('admin.Disable')}}</option>
                                                                </select>
                                                            </div>
                                                            <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                                    </form>
