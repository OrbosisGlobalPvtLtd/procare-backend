      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.language') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Languages')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.language.update', $language->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                @if ($language->id != $lang_firstId)
                                <div class="form-group col-12">
                                    <label>{{__('admin.Country Code')}} (  <a href="https://www.iban.com/country-codes" target="_blank">{{__('admin.See Code Lists')}}</a> )  <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="country_code" value="{{ $language->country_code}}">
                                </div>
                                @endif        
